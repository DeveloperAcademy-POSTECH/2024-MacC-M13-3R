...
extension Font {
    ...
    static let RLargeTitle: Font = .custom("GmarketSansBold", size: 28)
    static let RTitle: Font = .custom("SpoqaHanSansNeo-Bold", size: 18)
    static let RHeadline: Font = .custom("GmarketSansMedium", size: 16)
